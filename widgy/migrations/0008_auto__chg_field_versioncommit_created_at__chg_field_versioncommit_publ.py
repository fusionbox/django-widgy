...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VersionCommit.created_at'
        db.alter_column(u'widgy_versioncommit', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'VersionCommit.publish_at'
        db.alter_column(u'widgy_versioncommit', 'publish_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'VersionCommit.created_at'
        db.alter_column(u'widgy_versioncommit', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'VersionCommit.publish_at'
        db.alter_column(u'widgy_versioncommit', 'publish_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
