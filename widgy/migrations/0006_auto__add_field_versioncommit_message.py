...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VersionCommit.message'
        db.add_column('widgy_versioncommit', 'message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VersionCommit.message'
        db.delete_column('widgy_versioncommit', 'message')
