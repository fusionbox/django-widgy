...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FormSubmission.updated_at'
        raise RuntimeError("Cannot reverse this migration. 'FormSubmission.updated_at' and its values cannot be restored.")
    ...
    models = {
        ...
        u'form_builder.form': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ident': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "u'Untitled form 2'", 'max_length': '255'})
        },
