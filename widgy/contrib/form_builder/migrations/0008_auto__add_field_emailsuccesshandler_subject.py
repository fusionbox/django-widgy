...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'EmailSuccessHandler.subject'
        db.delete_column('form_builder_emailsuccesshandler', 'subject')
    ...
    models = {
        ...
        'form_builder.formsubmission': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)'}),
