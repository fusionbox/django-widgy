...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('widgy_cms_contentpage', (
        ...
        db.send_create_signal('cms', ['ContentPage'])

        # Adding model 'Bucket'
        db.create_table('widgy_cms_bucket', (
        ...
        db.send_create_signal('cms', ['Bucket'])

        # Adding model 'TwoColumnLayout'
        db.create_table('widgy_cms_twocolumnlayout', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('cms', ['TwoColumnLayout'])

        # Adding model 'TextContent'
        db.create_table('widgy_cms_textcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('cms', ['TextContent'])
        ...
        db.create_table('cms_imagecontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('mezzanine.core.fields.FileField')(max_length=255)),
        ))
        db.send_create_signal('cms', ['ImageContent'])


    def backwards(self, orm):
        # Deleting model 'ContentPage'
        db.delete_table('widgy_cms_contentpage')

        # Deleting model 'Bucket'
        db.delete_table('widgy_cms_bucket')

        # Deleting model 'TwoColumnLayout'
        db.delete_table('widgy_cms_twocolumnlayout')

        # Deleting model 'TextContent'
        db.delete_table('widgy_cms_textcontent')
        ...
        db.delete_table('cms_imagecontent')
    ...
    models = {
        ...
        'cms.commoncallout': {
            'Meta': {'object_name': 'CommonCallout'},
        ...
        'cms.commoncalloutcontent': {
            'Meta': {'object_name': 'CommonCalloutContent', 'db_table': "'widgy_cms_commoncalloutcontent'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inherits_from': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cms.CommonCallout']", 'null': 'True', 'blank': 'True'})
        },
        'cms.contentpage': {
