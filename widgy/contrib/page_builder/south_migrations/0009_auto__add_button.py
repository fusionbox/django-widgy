...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Button'
        db.create_table('page_builder_button', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('link_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['contenttypes.ContentType'])),
            ('link_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
        ))
        db.send_create_signal('page_builder', ['Button'])


    def backwards(self, orm):
        # Deleting model 'Button'
        db.delete_table('page_builder_button')
    ...
    models = {
        ...
        'page_builder.button': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link_content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
