...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnsafeHtml'
        db.create_table('page_builder_unsafehtml', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('page_builder', ['UnsafeHtml'])


    def backwards(self, orm):
        # Deleting model 'UnsafeHtml'
        db.delete_table('page_builder_unsafehtml')
