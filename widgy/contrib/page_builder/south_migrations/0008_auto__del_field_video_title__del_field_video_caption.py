...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('page_builder_video', 'title')

        # Deleting field 'Video.caption'
        db.delete_column('page_builder_video', 'caption')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Video.title'
        raise RuntimeError("Cannot reverse this migration. 'Video.title' and its values cannot be restored.")
        # Adding field 'Video.caption'
        db.add_column('page_builder_video', 'caption',
