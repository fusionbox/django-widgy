...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Html.content'
        db.alter_column('page_builder_html', 'content', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Html.content'
        db.alter_column('page_builder_html', 'content', self.gf('django.db.models.fields.TextField')(null=True))
