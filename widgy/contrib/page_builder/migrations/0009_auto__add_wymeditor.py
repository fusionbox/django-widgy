...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Wymeditor'
        db.create_table('page_builder_wymeditor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('widgy.contrib.page_builder.wymeditor.WYMEditorField')()),
            ('_nodes', self.gf('widgy.generic.ProxyGenericRelation')(object_id_field='content_id', to=orm['widgy.Node'])),
        ))
        db.send_create_signal('page_builder', ['Wymeditor'])


    def backwards(self, orm):
        # Deleting model 'Wymeditor'
        db.delete_table('page_builder_wymeditor')
    ...
    models = {
        ...
        'page_builder.figure': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.CharField', [], {'default': "'center'", 'max_length': '50'}),
        ...
        'page_builder.wymeditor': {
            'Meta': {'object_name': 'Wymeditor'},
            '_nodes': ('widgy.generic.ProxyGenericRelation', [], {'object_id_field': "'content_id'", 'to': "orm['widgy.Node']"}),
            'content': ('widgy.contrib.page_builder.wymeditor.WYMEditorField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'widgy.node': {
