...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Callout.callout'
        db.delete_column('page_builder_callout', 'callout_id')

        # Adding field 'Callout.root_node'
        db.add_column('page_builder_callout', 'root_node',
                      self.gf('widgy.forms.WidgyField')(to=orm['widgy.Node'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Callout.callout'
        db.add_column('page_builder_callout', 'callout',
                      self.gf('widgy.forms.WidgyField')(to=orm['widgy.Node'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'Callout.root_node'
        db.delete_column('page_builder_callout', 'root_node_id')
