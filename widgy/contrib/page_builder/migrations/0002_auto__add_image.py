...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('page_builder_image')
    ...
    models = {
        ...
        'page_builder.image': {
            ...
            '_nodes': ('widgy.generic.ProxyGenericRelation', [], {'object_id_field': "'content_id'", 'to': "orm['widgy.Node']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'image_widgets'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['filer.Image']"})
        },
