...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VersionTracker'
        db.create_table('widgy_versiontracker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('head', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['widgy.VersionCommit'], null=True)),
            ('working_copy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['widgy.Node'])),
        ))
        db.send_create_signal('widgy', ['VersionTracker'])

        # Adding model 'VersionCommit'
        db.create_table('widgy_versioncommit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'VersionTracker'
        db.delete_table('widgy_versiontracker')

        # Deleting model 'VersionCommit'
        db.delete_table('widgy_versioncommit')
    ...
    models = {
        ...
        'widgy.versiontracker': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'working_copy': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['widgy.Node']"})
        }
    }
