...
class TestMarkdownXss(TestCase):
    def test_it(self):
        test_cases = [
            ...
            ("<img SRC=JaVaScRiPt:alert('XSS')>", 'JaCaScRiPt:'),
            ('<div style="background: url("asdf");"></div>', 'style='),
            ...
            (r"<div style=\"background-image:\0075\0072\006C\0028'\006a\0061\0076\0061\0073\0063\0072\0069\0070\0074\003a\0061\006c\0065\0072\0074\0028.1027\0058.1053\0053\0027\0029'\0029\"></div>", 'style='),
