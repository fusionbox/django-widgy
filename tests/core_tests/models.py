...
class HasAWidgy(models.Model):
    widgy = WidgyField(
        ...
        blank=True,
        root_choices=[Layout],
        site='core_tests.widgy_config.widgy_site',
    )
...
class VersionedPage2(models.Model):
    bar = VersionedWidgyField(site='core_tests.widgy_config.widgy_site', related_name='asdf', null=True)


class VersionedPage3(models.Model):
    foo = VersionedWidgyField(site='core_tests.widgy_config.widgy_site', related_name='+')
...
class VersionPageThrough(models.Model):
    widgy = VersionedWidgyField(site='core_tests.widgy_config.widgy_site', related_name='+')
